  ...
  function buildAutoHUD(){
    ...
    root.innerHTML = `
      <div class="auto-hud-wrap">
        <div class="auto-hud-top">
          <div class="auto-hud-box">
            <div><span class="auto-label">SCORE</span><span id="score">0</span></div>
            <div><span class="auto-label">HI</span><span id="hiscore">0</span></div>
            <div><span class="auto-label">STAGE</span><span id="stage">1</span></div>
            <div><span class="auto-label">AREA</span><span id="area">NORMAL</span></div>
          </div>
          <div class="auto-hud-box">
            <div><span class="auto-label">LIFE</span><span id="lives">3</span></div>
            <div><span class="auto-label">POWER</span><span id="power">2</span></div>
            <div><span class="auto-label">BOMB</span><span id="bombs">3</span></div>
            <div><span class="auto-label">WEP</span><span id="weapon">SPREAD</span></div>
          </div>
          <div class="auto-hud-box">
            <div><span class="auto-label">OPT</span><span id="options">1</span></div>
            <div><span class="auto-label">SHIELD</span><span id="shield">0</span></div>
            <div><span class="auto-label">MULTI</span><span id="multiplier">1.0</span></div>
            <div><span class="auto-label">GRAZE</span><span id="graze">0</span></div>
            <div><span class="auto-label">OD</span><span id="overdriveText">READY</span></div>
          </div>
        </div>
        ...
        <div class="auto-panel auto-settings ui-clickable" id="settings">
          <h2>SETTINGS</h2>
          <label><input type="checkbox" id="autofireToggle" /> 自動発弾連射</label>
          ...
          <div class="hint">V: 手動OVERDRIVE / F: オプション隊形切替 / D: DEBUG表示切替</div>
        </div>
        ...
        <div class="auto-panel auto-debug ui-clickable" id="debugPanel">
          ...
          <div class="auto-debug-row">
            <button id="toggleDebugBtn" type="button">DEBUG: ON</button>
            <button id="copyLogBtn" type="button">ログコピー</button>
          </div>
          <div class="hint">localStorage へ直近ログ保存</div>
        </div>

        <div class="auto-overlay" id="overlay">
          <div class="auto-panel large">
            <h1 id="overlayTitle">VERTICAL SHOOTER</h1>
            <p id="overlayText">S-RANK AUTO HUD v5.8</p>
            <ul>
              <li>HUDをJSで自動生成</li>
              <li>UI要素欠落でも起動不能にならない</li>
              <li>デバッグは通常非表示</li>
            </ul>
